                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-5">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    <div class="card-header"><h3 class="text-center font-weight-light my-4">Register Credential Link Page</h3></div>
                                  
                                    <div class="card-body">
                                        <form action="<?php echo site_url('UpdateCredential/save_credential'); ?>" method="post" >
