...
<html lang="en">
    ...
    <body class="bg-primary">
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-5">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    <div class="card-header"><h3 class="text-center font-weight-light my-4">Signup Page</h3></div>
                            ...
                            <?php endif;?>
                                    <div class="card-body">
                                        ...
                                        <button type="submit"class="btn btn-primary ">Signup</button>
                                          ...
                                          <a  href="<?php echo site_url('/kurio'); ?>" class="btn btn-success" > Home</a> 

                                          <a  href="<?php echo site_url('kurio/signin'); ?>" >Admin Login</a>

                                        <a  href="<?php echo site_url('kurio/user'); ?>" >User Login</a>
        ...
        <script src="<?php echo site_url('assets/demo/chart-area-demo.js');?>"></script>
        <script src="<?php echo site_url('assets/demo/chart-bar-demo.js');?>"></script>
        <script src="https://cdn.jsdelivr.net/npm/simple-datatables@7.1.2/dist/umd/simple-datatables.min.js" crossorigin="anonymous"></script>
        <script src="<?php echo site_url('js/datatables-simple-demo.js');?>"></script>
    </body>
</html>
