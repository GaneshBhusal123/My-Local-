        ...
        <form action="#" method="POST" enctype="multipart/form-data" id="add_post_form" novalidate>
          <div class="modal-body p-5">
              ...
              <div class="mb-3">
                ...
                <div class="invalid-feedback">Designation Is Required
                </div>
              </div>
           ...
           <div class="mb-3">
              <label>Profile Pic</label>
                ...
                <div class="invalid-feedback">Profile Pic is required!
      ...
      <div class="modal-content">
        ...
        <form action="#" method="POST" enctype="multipart/form-data" id="edit_post_form" novalidate>
          ...
          <div class="modal-body p-5">
           ...
           <div class="mb-3">
             <label>Designation</label>
              <select name="designation" id="designation" placeholder="Select designation" class="form-control">
                <option value="PHP">PHP</option>
                <option value="JAVA">JAVA</option>
                <option value="DOTNET">DOTNET</option>
                <option value="React">REACT</option>
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <h5 id="detail_post_designation"></h5>
          <p id="created" class="fst-italic"></p>
        </div>
        <div class="modal-footer">
          <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
        </div>
      ...
      <div class="col-lg-12">
        <div class="card shadow">
          <div class="card-header d-flex justify-content-between align-items-center">
            ...
            <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#add_post_modal">Add</button>
          </div>
          <div class="card-body">
      ...
      $(document).delegate('.post_edit_btn', 'click', function(e) {
        ...
        $.ajax({
          ...
          success: function(response){
            ...
            $("#name").val(response.message.title);
            $("#designation ").val(response.message.category);
            $("#post_image").html('<img src="<?= base_url(
                "Public/Upload"
            ) ?>/' + response.message.image + '" class="img-fluid mt-2 img-thumbnail" height="70 px" width="70 px">');
          }
        });
      });
      ...
      $(document).delegate('.post_detail_btn', 'click', function(e) {
        ...
        $.ajax({
          ...
          success: function(response){
            ...
            $("#detail_post_name").text(response.message.title);
            $("#designation").text(response.message.category);
            $("#image").text(response.message.body);
            $("#created").text(response.message.created_at);
          }
        });
      });
