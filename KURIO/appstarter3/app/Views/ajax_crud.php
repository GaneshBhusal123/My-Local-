          ...
          <div class="row">
               <div class="col-md-12">
                    ...
                    <div id="filepreview" class="displaynone" > 
                          <img src="" class="displaynone" with="100px" height="100px"><br>

                          <a href="#" class="displaynone" >Click Here..</a>
                    </div>
                    <!-- File upload form -->
                    <form method="post" action="<?=site_url('crud/fileUpload')?>" enctype="multipart/form-data">
